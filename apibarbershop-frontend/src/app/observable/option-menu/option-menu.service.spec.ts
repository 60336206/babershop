...
describe('OptionMenuService', () => {
  let component: OptionMenuService;
  ...
  beforeEach(async () => {
    ...
    TestBed.configureTestingModule({ providers: [OptionMenuService] });

    component = TestBed.inject(OptionMenuService);
  });
  ...
  it('should call data$ (success)', async () => {
    ...
    try { component.data$(); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call data$ (error)', async () => {
  ...
  it('should call data$ (reject)', async () => {
  ...
  it('should call sendData (success)', async () => {
    (window as any).apiMockResponse = { type: 'success', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
    ...
    try { component.sendData({ target: { files: [new Blob([""], {type:"image/jpeg"})] }, value: "test" } as any); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call sendData (error)', async () => {
    (window as any).apiMockResponse = { type: 'error', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
  ...
  it('should call sendData (reject)', async () => {
    (window as any).apiMockResponse = 'REJECT';

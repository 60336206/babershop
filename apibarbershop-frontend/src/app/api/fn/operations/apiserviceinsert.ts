...
export interface ApiserviceinsertParams {
  body: {
    name: string;
    description: string;
    price: number;
...
export function apiserviceinsert(http: HttpClient, rootUrl: string, params: ApiserviceinsertParams, context?: HttpContext): Observable<StrictHttpResponse<any>> {

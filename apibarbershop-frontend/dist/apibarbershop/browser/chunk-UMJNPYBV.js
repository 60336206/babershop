...
// src/app/layout/admin/admin-layout.ts
var _forTrack0 = ($index, $item) => $item.route;
function AdminLayout_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminLayout_For_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminLayout_For_8_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 33);
  }
}
function AdminLayout_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 31);
    \u0275\u0275element(1, "i");
    \u0275\u0275conditionalCreate(2, AdminLayout_For_8_Conditional_2_Template, 2, 1, "span", 32);
    \u0275\u0275conditionalCreate(3, AdminLayout_For_8_Conditional_3_Template, 1, 0, "span", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", item_r2.route)("pTooltip", ctx_r2.sidebarCollapsed ? item_r2.label : "");
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("pi ", item_r2.icon, " nav-icon"));
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.sidebarCollapsed ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isActive(item_r2.route) ? 3 : -1);
  }
}
function AdminLayout_Conditional_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("image", ctx_r2.user.photo);
  }
}
function AdminLayout_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
...
var AdminLayout = class _AdminLayout {
  ...
  navItems = [];
  profileItems = [
    { label: "Cerrar sesi\xF3n", icon: "pi pi-sign-out", command: () => this.logout() }
  ];
  ngOnInit() {
    const allNavItems = [
      ...
      { label: "Galer\xEDa", icon: "pi-images", route: "/gallery" }
    ];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayout, selectors: [["app-admin-layout"]], decls: 37, vars: 14, consts: [["menu", ""], [1, "admin-shell"], [1, "admin-sidebar"], [1, "sidebar-brand"], [1, "brand-logo"], [1, "pi", "pi-scissors"], [1, "brand-name"], [1, "sidebar-nav"], ["tooltipPosition", "right", 1, "nav-item", 3, "routerLink", "active", "pTooltip"], [1, "sidebar-footer"], [1, "collapse-btn", 3, "click"], [1, "pi"], [1, "admin-main"], [1, "admin-topbar"], [1, "topbar-left"], [1, "mobile-menu-btn", 3, "click"], [1, "pi", "pi-bars"], [1, "breadcrumb"], [1, "breadcrumb-home"], [1, "pi", "pi-angle-right", "breadcrumb-sep"], [1, "breadcrumb-current"], [1, "topbar-right"], [1, "user-chip", 3, "click"], ["shape", "circle", "size", "normal", 3, "image"], [1, "user-initials-avatar"], [1, "user-chip-info"], [1, "user-chip-name"], [1, "user-chip-role"], [1, "pi", "pi-angle-down", "text-slate-400", "text-xs"], [3, "model", "popup"], [1, "admin-content"], ["tooltipPosition", "right", 1, "nav-item", 3, "routerLink", "pTooltip"], [1, "nav-label"], [1, "nav-active-bar"]], template: function AdminLayout_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 1)(1, "aside", 2)(2, "div", 3)(3, "div", 4);
      \u0275\u0275element(4, "i", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, AdminLayout_Conditional_5_Template, 2, 0, "span", 6);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "nav", 7);
      \u0275\u0275repeaterCreate(7, AdminLayout_For_8_Template, 4, 9, "a", 8, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "div", 9)(10, "button", 10);
      \u0275\u0275listener("click", function AdminLayout_Template_button_click_10_listener() {
        return ctx.toggleSidebar();
      });
      \u0275\u0275element(11, "i", 11);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(12, "div", 12)(13, "header", 13)(14, "div", 14)(15, "button", 15);
      \u0275\u0275listener("click", function AdminLayout_Template_button_click_15_listener() {
        return ctx.toggleSidebar();
      });
      \u0275\u0275element(16, "i", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 17)(18, "span", 18);
      \u0275\u0275text(19, "Admin");
      \u0275\u0275elementEnd();
      \u0275\u0275element(20, "i", 19);
      ...
      \u0275\u0275listener("click", function AdminLayout_Template_div_click_24_listener($event) {
        \u0275\u0275restoreView(_r1);
        const menu_r4 = \u0275\u0275reference(34);
        return \u0275\u0275resetView(menu_r4.toggle($event));
      });
      \u0275\u0275conditionalCreate(25, AdminLayout_Conditional_25_Template, 1, 1, "p-avatar", 23)(26, AdminLayout_Conditional_26_Template, 2, 1, "div", 24);
      ...
      \u0275\u0275element(32, "i", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275element(33, "p-menu", 29, 0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(35, "main", 30);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(!ctx.sidebarCollapsed ? 5 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.navItems);
      \u0275\u0275advance(4);
      \u0275\u0275classProp("pi-chevron-left", !ctx.sidebarCollapsed)("pi-chevron-right", ctx.sidebarCollapsed);
      \u0275\u0275advance(11);
      \u0275\u0275textInterpolate(ctx.pageName);
      \u0275\u0275advance(3);
      \u0275\u0275conditional((ctx.user == null ? null : ctx.user.photo) ? 25 : 26);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate2("", ctx.user == null ? null : ctx.user.firstName, " ", ctx.user == null ? null : ctx.user.surName);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.user == null ? null : ctx.user.role);
      \u0275\u0275advance(2);
      \u0275\u0275property("model", ctx.profileItems)("popup", true);
    }
  }, dependencies: [
    CommonModule,
    RouterModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminLayout, [{
    ...
    args: [{ selector: "app-admin-layout", standalone: true, imports: [
      ...
      BadgeModule,
      TooltipModule
    ], template: `<div class="admin-shell" [class.sidebar-collapsed]="sidebarCollapsed">
  ...
  <aside class="admin-sidebar">
    <div class="sidebar-brand">
      ...
      @if(!sidebarCollapsed) {
        <span class="brand-name">BarberShop</span>
      }
    </div>
  ...
  <div class="admin-main">
    ...
    <header class="admin-topbar">
      ...
      <div class="topbar-right">
        <div class="user-chip" (click)="menu.toggle($event)">
          @if(user?.photo) {
            <p-avatar [image]="user!.photo" shape="circle" size="normal" />
          } @else {
            <div class="user-initials-avatar">{{ userInitials }}</div>
          }
          <div class="user-chip-info">
            <span class="user-chip-name">{{ user?.firstName }} {{ user?.surName }}</span>
...
`, styles: ["/* src/app/layout/admin/admin-layout.css */\n.admin-shell {\n  display: flex;\n  height: 100vh;\n  overflow: hidden;\n  background: #f1f5f9;\n  --sidebar-w: 240px;\n  --sidebar-w-collapsed: 64px;\n  --topbar-h: 60px;\n  --transition: 0.25s cubic-bezier(.4,0,.2,1);\n}\n.admin-sidebar {\n  width: var(--sidebar-w);\n  background: #0f172a;\n  display: flex;\n  flex-direction: column;\n  flex-shrink: 0;\n  transition: width var(--transition);\n  overflow: hidden;\n  position: relative;\n  z-index: 100;\n}\n.admin-shell.sidebar-collapsed .admin-sidebar {\n  width: var(--sidebar-w-collapsed);\n}\n.sidebar-brand {\n  height: var(--topbar-h);\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0 1rem;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.06);\n  flex-shrink: 0;\n}\n.brand-logo {\n  width: 36px;\n  height: 36px;\n  background:\n    linear-gradient(\n      135deg,\n      #f59e0b,\n      #d97706);\n  border-radius: 10px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n}\n.brand-logo .pi {\n  color: #fff;\n  font-size: 1rem;\n}\n.brand-name {\n  font-size: 1rem;\n  font-weight: 700;\n  color: #f8fafc;\n  white-space: nowrap;\n  letter-spacing: -0.02em;\n}\n.sidebar-nav {\n  flex: 1;\n  padding: 0.75rem 0.5rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.2rem;\n  overflow-y: auto;\n  overflow-x: hidden;\n}\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.65rem 0.875rem;\n  border-radius: 10px;\n  text-decoration: none;\n  color: #cbd5e1;\n  font-size: 0.875rem;\n  font-weight: 500;\n  transition: all var(--transition);\n  position: relative;\n  white-space: nowrap;\n  cursor: pointer;\n}\n.nav-item:hover {\n  background: rgba(255, 255, 255, 0.07);\n  color: #f1f5f9;\n}\n.nav-item.active {\n  background: rgba(245, 158, 11, 0.15);\n  color: #fcd34d;\n}\n.nav-icon {\n  font-size: 1rem;\n  flex-shrink: 0;\n}\n.nav-active-bar {\n  position: absolute;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 3px;\n  height: 60%;\n  background: #f59e0b;\n  border-radius: 3px 0 0 3px;\n}\n.sidebar-footer {\n  padding: 0.75rem 0.5rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.06);\n}\n.collapse-btn {\n  width: 100%;\n  height: 36px;\n  background: rgba(255, 255, 255, 0.05);\n  border: none;\n  border-radius: 8px;\n  color: #94a3b8;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transition: all 0.2s;\n}\n.collapse-btn:hover {\n  background: rgba(255, 255, 255, 0.1);\n  color: #94a3b8;\n}\n.admin-main {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 0;\n}\n.admin-topbar {\n  height: var(--topbar-h);\n  background: #ffffff;\n  border-bottom: 1px solid #e2e8f0;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0 1.5rem;\n  flex-shrink: 0;\n  z-index: 50;\n}\n.topbar-left {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}\n.mobile-menu-btn {\n  display: none;\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 0.4rem;\n  border-radius: 8px;\n  color: #475569;\n  font-size: 1.1rem;\n  transition: background 0.2s;\n}\n.mobile-menu-btn:hover {\n  background: #f1f5f9;\n}\n.breadcrumb {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n  font-size: 0.875rem;\n}\n.breadcrumb-home {\n  color: #94a3b8;\n}\n.breadcrumb-sep {\n  color: #cbd5e1;\n  font-size: 0.75rem;\n}\n.breadcrumb-current {\n  font-weight: 600;\n  color: #0f172a;\n}\n.topbar-right {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}\n.user-chip {\n  display: flex;\n  align-items: center;\n  gap: 0.6rem;\n  cursor: pointer;\n  padding: 0.4rem 0.75rem;\n  border-radius: 10px;\n  transition: background 0.2s;\n}\n.user-chip:hover {\n  background: #f8fafc;\n}\n.user-initials-avatar {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  background:\n    linear-gradient(\n      135deg,\n      #0f172a,\n      #334155);\n  color: #fff;\n  font-size: 0.7rem;\n  font-weight: 700;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n  letter-spacing: 0.05em;\n}\n.user-chip-info {\n  display: flex;\n  flex-direction: column;\n}\n.user-chip-name {\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: #1e293b;\n  line-height: 1.2;\n}\n.user-chip-role {\n  font-size: 0.7rem;\n  color: #94a3b8;\n}\n.admin-content {\n  flex: 1;\n  overflow-y: auto;\n  padding: 1.5rem;\n}\n@media (max-width: 768px) {\n  .admin-sidebar {\n    position: fixed;\n    top: 0;\n    left: 0;\n    height: 100%;\n    z-index: 200;\n    transform: translateX(0);\n    width: var(--sidebar-w) !important;\n    transition: transform var(--transition);\n  }\n  .admin-shell.sidebar-collapsed .admin-sidebar {\n    transform: translateX(-100%);\n    width: var(--sidebar-w) !important;\n  }\n  .mobile-menu-btn {\n    display: flex;\n  }\n  .user-chip-info {\n    display: none;\n  }\n  .admin-content {\n    padding: 1rem;\n  }\n}\n/*# sourceMappingURL=admin-layout.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminLayout, { className: "AdminLayout", filePath: "src/app/layout/admin/admin-layout.ts", lineNumber: 37 });
})();
export {
  AdminLayout
};
//# sourceMappingURL=chunk-UMJNPYBV.js.map

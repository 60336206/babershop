...
class AppointmentCommentControllerTest {

    @InjectMocks
    private AppointmentCommentController target;

    @Mock
    private BusinessAppointmentComment businessAppointmentComment;
    ...
    @Test
    void testActionGetByAppointment() {
        assertDoesNotThrow(() -> {
            target.actionGetByAppointment("test-id");
        });
    }

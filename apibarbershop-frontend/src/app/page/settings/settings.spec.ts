...
describe('Settings', () => {
  ...
  it('should call loadSettings (success)', async () => {
    ...
    try { component.loadSettings(); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call loadSettings (error)', async () => {
  ...
  it('should call loadSettings (reject)', async () => {
  ...
  it('should call onLogoChange (success)', async () => {
    (window as any).apiMockResponse = { type: 'success', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
    ...
    try { component.onLogoChange({ target: { files: [new Blob([""], {type:"image/jpeg"})] }, value: "test" } as any); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call onLogoChange (error)', async () => {
    (window as any).apiMockResponse = { type: 'error', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
  ...
  it('should call onLogoChange (reject)', async () => {
    (window as any).apiMockResponse = 'REJECT';
  ...
  it('should call saveSettings (success)', async () => {
    (window as any).apiMockResponse = { type: 'success', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
    ...
    try { component.saveSettings(); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call saveSettings (error)', async () => {
    (window as any).apiMockResponse = { type: 'error', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
  ...
  it('should call saveSettings (reject)', async () => {
    (window as any).apiMockResponse = 'REJECT';

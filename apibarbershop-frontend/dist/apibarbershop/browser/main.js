...
import {
  CheckIcon
} from "./chunk-S7BWAJXG.js";
import {
  TimesIcon
} from "./chunk-ZM3B3NVI.js";
import {
  MotionDirective,
  MotionModule,
  zindexutils
...
var authGuard = (route, state) => {
  ...
  if (user?.role === "BARBER") {
    ...
    const isAllowed = allowed.some((a43) => state.url.startsWith(a43));
...
var routes = [
  ...
  {
    path: "",
    loadComponent: () => import("./chunk-WLYDRKUP.js").then((m5) => m5.Home)
  },
  {
    path: "booking",
    loadComponent: () => import("./chunk-MUC5IPM7.js").then((m5) => m5.AppointmentBooking)
  },
  // ── Auth ──
  {
    path: "auth/login",
    canActivate: [guestGuard],
    loadComponent: () => import("./chunk-KH5UXNE2.js").then((m5) => m5.Login)
  },
  // ── Panel Admin (layout compartido) ──
  {
    path: "",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-UMJNPYBV.js").then((m5) => m5.AdminLayout),
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-KCVKW23I.js").then((m5) => m5.Dashboard)
      },
      {
        path: "users",
        loadComponent: () => import("./chunk-QB5EQOMF.js").then((m5) => m5.Users)
      },
      {
        path: "customers",
        loadComponent: () => import("./chunk-NQEI6H7B.js").then((m5) => m5.Customers)
      },
      {
        path: "services",
        loadComponent: () => import("./chunk-CEW5ROLY.js").then((m5) => m5.Services)
      },
      {
        path: "appointments",
        loadComponent: () => import("./chunk-ILUUVAUQ.js").then((m5) => m5.Appointments)
      },
      {
        path: "schedules",
        loadComponent: () => import("./chunk-LYBSUKUQ.js").then((m5) => m5.Schedules)
      },
      {
        path: "gallery",
        loadComponent: () => import("./chunk-5QFIFWOC.js").then((m5) => m5.Gallery)
      }
    ]
  },
  // ── Fallback ──
...
var v = { root: o18, header: r18, headerCell: e14, columnTitle: d5, row: t8, bodyCell: l4, footerCell: c7, columnFooter: a8, footer: n4, dropPoint: i8, columnResizer: s5, resizeIndicator: g, sortIcon: u, loadingIcon: b, rowToggleButton: p2, filter: m, paginatorTop: h, paginatorBottom: k, colorScheme: f3, css };
...
var k2 = { root: o20, panel: r20, header: e16, title: c9, dropdown: d7, inputIcon: n6, selectMonth: t10, selectYear: a9, group: i9, dayView: l5, weekDay: u2, date: s6, monthView: g2, month: f4, yearView: h2, year: b2, buttonbar: m2, timePicker: p3, colorScheme: v2 };
...
var l8 = { toolbar: o25, toolbarItem: r25, overlay: e20, overlayOption: t12, content: d11 };
...
var l9 = { root: o29, navButton: r29, navIcon: e23, thumbnailsContent: t15, thumbnailNavButton: c10, thumbnailNavButtonIcon: n10, caption: a14, indicatorList: s7, indicatorButton: u3, insetIndicatorList: i12, insetIndicatorButton: d14, closeButton: g3, closeButtonIcon: f5, colorScheme: h3 };
...
var n14 = { root: o41, list: r40, option: d17, optionGroup: i15, checkmark: t18, emptyMessage: e28, colorScheme: l11 };
...
var b3 = { root: e32, meters: r45, label: a22, labelMarker: o46, labelIcon: l13, labelList: t22 };
...
var u5 = { root: o78, icon: r76, content: e50, text: n36, summary: a39, detail: s10, closeButton: c22, closeIcon: l16, colorScheme: t39 };
...
var k3 = { root: o85, header: r83, headerCell: e56, columnTitle: t41, row: c26, bodyCell: n38, footerCell: l18, columnFooter: d33, footer: a41, columnResizer: i27, resizeIndicator: g5, sortIcon: s11, loadingIcon: u6, nodeToggleButton: b4, paginatorTop: h4, paginatorBottom: m3, colorScheme: f10, css: css3 };
...
function ToastItem_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngTemplateOutlet", ctx_r0.headlessTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction2(2, _c04, ctx_r0.message, ctx_r0.onCloseIconClick));
  }
}
...
var ConfirmDialog = class _ConfirmDialog extends BaseComponent {
  ...
  option(name, k4) {
    ...
    if (source.hasOwnProperty(name)) {
      const value = k4 ? source[k4] : source[name];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function ConfirmDialog_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, Footer, 5)(dirIndex, _c05, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, _c4, 4)(dirIndex, _c5, 4)(dirIndex, _c6, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
...
var App = class _App {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 3, vars: 0, template: function App_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "p-toast")(1, "p-confirmdialog")(2, "router-outlet");
    }
  }, dependencies: [RouterOutlet, ToastModule, Toast, ConfirmDialogModule, ConfirmDialog], styles: ["\n[_nghost-%COMP%] {\n  display: block;\n  height: 100vh;\n}\n/*# sourceMappingURL=app.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, ToastModule, ConfirmDialogModule], template: `
    <p-toast />
    <p-confirmdialog />
    <router-outlet />
  `, styles: ["/* angular:styles/component:css;02678c1cb8d1ea5e208042d97fc6d4cc38d0bec4757e66082fc7ae91bd5b187e;C:/Users/USUARIO/Documents/DSIIproyeto/apibarbershop-frontend/src/app/app.ts */\n:host {\n  display: block;\n  height: 100vh;\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {

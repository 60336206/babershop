...
describe('Services', () => {
  ...
  it('should call onImageSelected (success)', async () => {
    (window as any).apiMockResponse = { type: 'success', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
    ...
    try { component.onImageSelected({ target: { files: [new Blob([""], {type:"image/jpeg"})] }, value: "test" } as any); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call onImageSelected (error)', async () => {
    (window as any).apiMockResponse = { type: 'error', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
  ...
  it('should call onImageSelected (reject)', async () => {
    (window as any).apiMockResponse = 'REJECT';
  ...
  it('should call saveService (success)', async () => {
    (window as any).apiMockResponse = { type: 'success', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
    ...
    try { component.saveService(); } catch(e) {}
    await new Promise(r => setTimeout(r, 50));
  });

  it('should call saveService (error)', async () => {
    (window as any).apiMockResponse = { type: 'error', idCustomer: 1, idAppointment: 1, listMessage: [], listCustomer: [{status: 1}], listService: [], listGallery: [], listUser: [{status:1}], listSchedule: [], listBarberSchedule: [] };
  ...
  it('should call saveService (reject)', async () => {
    (window as any).apiMockResponse = 'REJECT';
  ...
  it('should call getter nameFb', () => {
    try { const temp = component.nameFb; } catch(e) {}
  });
  it('should call getter descriptionFb', () => {
    try { const temp = component.descriptionFb; } catch(e) {}
  });
  it('should call getter priceFb', () => {
    try { const temp = component.priceFb; } catch(e) {}
  });
  it('should call getter durationMinutesFb', () => {
    try { const temp = component.durationMinutesFb; } catch(e) {}
  });
});
